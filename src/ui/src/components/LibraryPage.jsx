...
function PlaylistRow({ title, icon, items = [], onClickItem, onCreate, linkTo }) {
  const navigate = useNavigate()
  return (
    <section className="lib-section">
      <div className="lib-section-header">
        <h2 className="lib-section-title">{icon && <i className={icon}></i>} {title}</h2>
        {onCreate && (
      ...
      {items.length === 0 ? (
        <div className="lib-empty">{title === 'Playlists' ? 'No playlists yet. Create one!' : 'No videos'}</div>
      ) : (
        <div className="lib-hscroll">
          {items.map(v => (
            <div key={v.id} className="lib-hitem" onClick={() => onClickItem(v)}>
    ...
    <div className="lib-pl-card" onClick={onClick}>
      <div className="lib-pl-card-thumb">
        {playlist.items.length > 0 ? (
          ...
          <div className="lib-pl-card-empty"><i className="bi bi-music-note-list"></i></div>
        )}
...
export default function LibraryPage({
  ...
  openVideo, openMusicTrack,
  albums, loadAlbums, openAlbum,
}) {
  const navigate = useNavigate()
  ...
  useEffect(() => {
    ...
    fetchData('watch-history').then(d => setWatchHistory(Array.isArray(d) ? d.slice(0, 20) : []))
      ...
      <div id="libraryPage">
        ...
        <div className="lib-body">
          <div className="lib-mode-tabs">
            <button className="lib-mode-tab active">Music</button>
            <button className="lib-mode-tab" onClick={() => onToggleMusic(false)}>
          ...
          <div className="lib-album-toolbar">
            ...
            <button className="lib-create-btn" onClick={() => {
    ...
    <div id="libraryPage">
      ...
      <div className="lib-body">
        <div className="lib-mode-tabs">
          ...
          <button className="lib-mode-tab active">YouTube</button>
        </div>
        ...
        <section className="lib-section">
          <div className="lib-section-header">
            <h2 className="lib-section-title"><i className="bi bi-collection-play"></i> Playlists</h2>
            <button className="lib-create-btn" onClick={() => setShowCreate(true)}>
              <i className="bi bi-plus-lg"></i> New
            </button>
          </div>

          <div className="lib-pl-grid">
            <div className="lib-pl-card lib-pl-system" onClick={() => navigate('/library/liked')}>
              <div className="lib-pl-card-thumb">
            ...
            <div className="lib-pl-card lib-pl-system" onClick={() => navigate('/library/saved')}>
              <div className="lib-pl-card-thumb">
        ...
        {showCreate && (
          <div className="lib-create-overlay" onClick={() => setShowCreate(false)}>
            <div className="lib-create-modal" onClick={e => e.stopPropagation()}>
              <h3>New playlist</h3>
              <input
                type="text"
              ...
              <div className="lib-create-actions">
                <button className="lib-cancel-btn" onClick={() => { setShowCreate(false); setNewName('') }}>
                  Cancel
                </button>
